...
if __name__ == "__main__":
    ...
    #获取训练集
    trainDataArr, trainLabelArr = loadData('C:/Users/83621/Documents/vscode/KNN_code/Mnist/mnist_train.csv')
    #获取测试集
    testDataArr, testLabelArr = loadData('C:/Users/83621/Documents/vscode/KNN_code/Mnist/mnist_test.csv')
    #计算测试集正确率
